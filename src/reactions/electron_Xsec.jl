...
const XT_elastic = Xsec_Table{100}(
    ...
    # E_eV
    SVector(
        0.02, 0.0217968295997057, 0.0237550890299304, 0.0258892813855616, 0.028215212740996, 0.0307501092117468, 0.0335127445330393, 0.0365235791002564, 0.039804911500983, 0.0433810436609147,
        ...
        0.111762642907174, 0.121803564153021, 0.132746576624011, 0.144672725530893, 0.157670337306093, 0.171835673759452, 0.18727364500427, 0.204098586433693, 0.222435105501801, 0.242419004580766,
        0.264198286728862, 0.28793425181816, 0.31380269113996, 0.341995189335339, 0.372720543293075, 0.406206308523445, 0.442700484460551, 0.48247335117469, 0.525819471097685, 0.573059870586181,
        ...
        3.4900367355233, 3.80358680104573, 4.14530666850418, 4.51772715459547, 4.92360644833405, 5.36595053851748, 5.84803547642573, 6.37343163863428, 6.94603016963423, 7.57007180009662,
        8.25017825421218, 8.99138647871303, 9.79918594708031, 10.679559315217, 11.6390267296868, 12.6846941166701, 13.8243058092724, 15.0663019029467, 16.4198807638125, 17.8950671528154,
        ...
        46.1030863073023, 50.2450558130397, 54.7591459892265, 59.678788707629, 65.0404194088516, 70.8837469474066, 77.2520476800641, 84.192485975535, 91.7564635192176, 100.0
    ),

    # Xsec
    SVector(
        7.41e-20, 7.46390488799117e-20, 7.52265267089791e-20, 7.58667844156685e-20, 7.65645638222988e-20, 7.73775404083463e-20, 7.83997154772245e-20, 7.95137242670949e-20, 8.07278172553637e-20, 8.16114504786195e-20,
        ...
        1.13560876941874e-19, 1.15300286780145e-19, 1.1711235694855e-19, 1.19036608626683e-19, 1.21070315047552e-19, 1.22804809045091e-19, 1.24790652816047e-19, 1.27197564714813e-19, 1.29820717140758e-19, 1.3230272750716e-19,
        1.34980248654001e-19, 1.3672096406135e-19, 1.38339994143384e-19, 1.40104480284128e-19, 1.41108281164921e-19, 1.41126993453031e-19, 1.41147386880798e-19, 1.41169612484298e-19, 1.4119383486891e-19, 1.39338524586853e-19,
        ...
        9.69113680857526e-20, 9.22046958601722e-20, 8.70751692360401e-20, 8.25041373211974e-20, 7.78507203610191e-20, 7.3737805297488e-20, 6.98061449580101e-20, 6.600109429116e-20, 6.20663219377061e-20, 5.80833186873984e-20,
        ...
        1.97550556263996e-20, 1.71970765585233e-20, 1.53011586845249e-20, 1.32349087427958e-20, 1.18398951477871e-20, 1.04497630189409e-20, 9.3671518943891e-21, 8.5646011219572e-21, 7.97704755365477e-21, 7.4e-21
    )
)
...
const XT_mom = Xsec_Table{100}(
    ...
    # E_eV
    SVector(
        0.001, 0.00112332403297803, 0.00126185688306602, 0.0014174741629268, 0.00159228279334109, 0.00178864952905744, 0.00200923300256505, 0.00225701971963392, 0.00253536449397011, 0.0028480358684358,
        ...
        0.0327454916287773, 0.0367837977182863, 0.0413201240011534, 0.0464158883361278, 0.0521400828799968, 0.0585702081805667, 0.0657933224657568, 0.0739072203352578, 0.0830217568131974, 0.093260334688322,
        0.104761575278967, 0.1176811952435, 0.132194114846603, 0.148496826225447, 0.166810053720006, 0.187381742286038, 0.210490414451202, 0.236448941264541, 0.265608778294669, 0.298364724028334,
        0.335160265093884, 0.376493580679247, 0.42292428743895, 0.47508101621028, 0.533669923120631, 0.599484250318941, 0.673415065775082, 0.756463327554629, 0.849753435908645, 0.954548456661834,
        ...
        3.43046928631492, 3.85352859371053, 4.32876128108306, 4.86260158006535, 5.46227721768434, 6.13590727341317, 6.8926121043497, 7.74263682681127, 8.69749002617784, 9.77009957299225,
    ...
    # Xsec
    SVector(
        7.25e-20, 7.2561662016489e-20, 7.26e-20, 7.26e-20, 7.26307609311137e-20, 7.26962165096858e-20, 7.2803693201026e-20, 7.29028078878536e-20, 7.30353644939701e-20, 7.33480358684358e-20,
        7.35597801413392e-20, 7.36781440991414e-20, 7.38259120810176e-20, 7.417441495569e-20, 7.45282414044449e-20, 7.47167102978051e-20, 7.50568438703706e-20, 7.55104045091927e-20, 7.59556541539484e-20, 7.64669765366929e-20,
        7.70941240875961e-20, 7.75990279815909e-20, 7.81661986600595e-20, 7.88033151139838e-20, 7.96055038948963e-20, 8.05536914014768e-20, 8.16147467717249e-20, 8.2578492860316e-20, 8.37371113724388e-20, 8.52092440889958e-20,
        8.66158319026476e-20, 8.81100051557659e-20, 8.97488421603921e-20, 9.14814020342834e-20, 9.32778223775991e-20, 9.5013956208753e-20, 9.68483306164392e-20, 9.88768050838144e-20, 1.01034568930771e-19, 1.03217273631431e-19,
        1.05628507179398e-19, 1.08147833072482e-19, 1.10591705424945e-19, 1.13254481616823e-19, 1.15909441033201e-19, 1.18685809074325e-19, 1.21291003102925e-19, 1.23990689891512e-19, 1.2683600760311e-19, 1.29849554610607e-19,
        1.32847981472605e-19, 1.36195980035019e-19, 1.39727624408165e-19, 1.4343075215093e-19, 1.4735487507972e-19, 1.51566992020412e-19, 1.55270753288754e-19, 1.59479629705286e-19, 1.63739890872254e-19, 1.68145583636459e-19,
        1.72593219159356e-19, 1.77067553103882e-19, 1.79295716618697e-19, 1.81546459193557e-19, 1.81983822844098e-19, 1.81551493560801e-19, 1.78907027401547e-19, 1.7513417863992e-19, 1.69103623362782e-19, 1.61410527872098e-19,
        1.51693892413075e-19, 1.40778962282268e-19, 1.30063136969147e-19, 1.18799106660621e-19, 1.08549792238819e-19, 9.80837074448743e-20, 8.74141693286693e-20, 7.76567312223949e-20, 6.85225897643995e-20, 5.9639203416062e-20,
        ...
        8.51564445211127e-21, 6.60605127787994e-21, 5.4169390078913e-21, 4.22031839411268e-21, 3.54374120653704e-21, 2.91940181955271e-21, 2.40643500639098e-21, 2.03232353707816e-21, 1.72033323512038e-21, 1.49e-21
    )
)
...
function Xsec_Electron_Momentum_Transfer_vectorized!(E_eV::Vector{Float64}, out_Xsec::Vector{Float64}; XT = XT_mom::Xsec_Table)
    ...
    idx = (E_eV .>= 100)
    return out_Xsec[idx] .= (1.2402e-18) .* E_eV[idx] .^ (-1.10575) # Note
end
...
function Xsec_Electron_Ionization!(in_Energy_eV::AbstractVector{Float64}, out_Xsec::AbstractVector{Float64})
    ...
    for (k, E_eV) in pairs(in_Energy_eV)
        ...
        elseif E_eV < 70.0
            out_Xsec[k] = (
                (-4.0855e-21) + (3.3057e-22) * (E_eV) + (-3.852e-24) * (E_eV .^ 2) +
                    (-5.1458e-26) * (E_eV .^ 3) + (1.4436e-27) * (E_eV .^ 4) +
                    (-8.5308e-30) * (E_eV .^ 5)
            ) / (0.53 .^ 2)
        elseif E_eV < 1000.0
            out_Xsec[k] = (
                (1.7117e-22) + (8.398e-22) * exp(-(E_eV + 61.36476) / 226.35342) +
                    (2.2991e-21) * exp(-(E_eV + 61.36476) / 226.36454) +
                    (1.111e-21) * exp(-(E_eV + 61.36476) / 1289.79864)
            ) / (0.53 .^ 2)
        elseif E_eV < 100000.0
...
function Xsec_Electron_Excitation!(in_Energy_eV::AbstractVector{Float64}, reaction_flag::Int, out_Xsec::AbstractVector{Float64})
    ...
    elseif reaction_flag == 2
        ...
        for (k, E_eV) in pairs(in_Energy_eV)
            ...
            elseif (E_eV <= 20.0)
                out_Xsec[k] = 1.0e-20 * (
                    -21.104 * (E_eV - 12.982) * exp(-7.5183 * (E_eV - 12.982)) + 0.33273 * ((E_eV - 12.982) .^ (-0.12174)) +
                        0.1565 * (E_eV - 12.982) * exp(-0.82171 * (E_eV - 12.982))
                )
            elseif (E_eV <= 21.0)
                out_Xsec[k] = ((0.3005 - 0.2659) * (E_eV - 20) + 0.2659) * (1.0e-20)
            elseif (E_eV > 21.0)
                out_Xsec[k] = 1.0e-20 * (
                    (1.2634 / (((E_eV / 12.286) .^ 0.97791))) * ((((E_eV / 12.286) - 1) / ((E_eV / 12.286) + 1)) .^ 0.84579) *
    ...
    elseif reaction_flag == 4
        ...
        for (k, E_eV) in pairs(in_Energy_eV)
            ...
            elseif (E_eV <= 13.5)
                out_Xsec[k] = (
                    0.85359 * (E_eV - 11.74) * exp(-1.99352 * (E_eV - 11.74)) + 0.13358 * ((E_eV - 11.74) .^ (1.18804)) -
                        0.18351 * (E_eV - 11.74) * exp(-0.37682 * (E_eV - 11.74))
                ) * (1.0e-20)
            else
                out_Xsec[k] = 0.0
            end
    ...
    elseif reaction_flag == 6
        ...
        for (k, E_eV) in pairs(in_Energy_eV)
            ...
            elseif (E_eV <= 200.0)
                out_Xsec[k] = 1.0e-20 * (
                    (1.97053 / (((E_eV / 7.33785) .^ 0.65748))) * ((((E_eV / 7.33785) - 1) / ((E_eV / 7.33785) + 1)) .^ 3.35052)
    ...
    elseif reaction_flag == 7
        ...
        for (k, E_eV) in pairs(in_Energy_eV)
            ...
            elseif (E_eV <= 25.0)
                out_Xsec[k] = 1.0e-20 * (
                    0.15964 * (E_eV - 13.89051) * exp(-0.92561 * (E_eV - 13.89051)) + 0.02979 * ((E_eV - 13.89051) .^ (0.33597)) -
                        0.22154 * (E_eV - 13.89051) * exp(-1.53561 * (E_eV - 13.89051))
                )
            elseif (E_eV <= 200.0)
                out_Xsec[k] = 1.0e-20 * (
                    (3.32695 / (((E_eV / 5.9768) .^ 0.69512))) * ((((E_eV / 5.9768) - 1) / ((E_eV / 5.9768) + 1)) .^ 4.69437) *
    ...
    elseif reaction_flag == 8
        ...
        for (k, E_eV) in pairs(in_Energy_eV)
            ...
            elseif (E_eV <= 22.0)
                out_Xsec[k] = 1.0e-20 * (
                    0.18354 * (E_eV - 14.65758) * exp(-0.53837 * (E_eV - 14.65758)) + 0.00708 * ((E_eV - 14.65758) .^ (0.583)) -
                        0.16135 * (E_eV - 14.65758) * exp(-0.52336 * (E_eV - 14.65758))
                )
            elseif (E_eV <= 200.0)
                out_Xsec[k] = 1.0e-20 * (
                    (0.82715 / (((E_eV / 7.29033) .^ 0.59361))) * ((((E_eV / 7.29033) - 1) / ((E_eV / 7.29033) + 1)) .^ 3.47936) *
    ...
    elseif reaction_flag == 9
        ...
        for (k, E_eV) in pairs(in_Energy_eV)
            ...
            elseif (E_eV <= 27.0)
                out_Xsec[k] = 1.0e-20 * (
                    0.06117 * (E_eV - 14.80461) * exp(-0.78927 * (E_eV - 14.80461)) + 0.01027 * ((E_eV - 14.80461) .^ (0.38943)) -
                        0.03799 * (E_eV - 14.80461) * exp(-0.94223 * (E_eV - 14.80461))
                )
            elseif (E_eV <= 200.0)
                out_Xsec[k] = 1.0e-20 * (
                    (2.27572 / (((E_eV / 4.76266) .^ 0.65726))) * ((((E_eV / 4.76266) - 1) / ((E_eV / 4.76266) + 1)) .^ 6.4372) *
...
function Xsec_Electron_Dissociative_Ionization!(in_Energy_eV::AbstractVector{Float64}, out_Xsec::AbstractVector{Float64})
    ...
    for (k, E_eV) in pairs(in_Energy_eV)
        ...
        elseif E_eV < 975.0
            out_Xsec[k] = -1.26e-34 * E_eV^4 - 7.6e-31 * E_eV^3 + 2.29e-27 * E_eV^2 - 2.09e-24 * E_eV + 7.61e-22
        else
            out_Xsec[k] = 0.0
        end
    end
...
function Xsec_Electron_Recombination_with_H2_Ion!(in_Energy_eV::AbstractVector{Float64}, out_Xsec::AbstractVector{Float64})
    ...
    for (k, E_eV) in pairs(in_Energy_eV)
        if E_eV <= 0.0
            ...
            term1 = 1.0 / (E_eV^0.665 * (1.0 + 1.1 * E_eV^0.512 + 0.011 * E_eV^3.1))
...
function Xsec_Electron_Recombination_with_H3_Ion!(in_Energy_eV::AbstractVector{Float64}, out_Xsec::AbstractVector{Float64})
    ...
    for (k, E_eV) in pairs(in_Energy_eV)
        if E_eV <= 0.0
            ...
            Xsec_HL = 0.0646 * E_eV^1.478 * 1.0e-20
            Xsec_HR = 634.22 / E_eV^2.605 * 1.0e-20
