...
export add_coil!, get_powered_coils, get_passive_coils
export find_coil_by_name, set_coil_voltage!, get_coil_voltage, update_all_voltages!
...
export get_all_currents, get_powered_currents, get_all_voltages, get_powered_voltages
export set_all_currents!, set_powered_currents!, set_coil_current!, get_coil_current
export get_coil_voltage_at_time, set_coil_voltage_function!
export get_all_voltages_at_time, get_powered_voltages_at_time
