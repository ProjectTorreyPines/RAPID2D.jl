...
@testitem "A channel every species shares passes through untouched" begin
    ...
    ch = DiffusionChannel(fill(3.0, 4, 5), fill(0.5, 4, 5), fill(7.0, 4, 5), fill(0.25, 4, 5))
...
@testitem "Equal-valued but distinct channels mix back to their common value" begin
    ...
    mk() = DiffusionChannel(fill(3.0, 4, 5), fill(0.5, 4, 5), fill(7.0, 4, 5), fill(0.25, 4, 5))
...
@testitem "Mixing weights the speed and the diffusivity, and derives the step from both" begin
    ...
    ch1 = DiffusionChannel(fill(2.0, 3, 3), fill(3.0, 3, 3), fill(4.0, 3, 3), fill(5.0, 3, 3))
    ch2 = DiffusionChannel(fill(6.0, 3, 3), fill(1.0, 3, 3), fill(8.0, 3, 3), fill(1.0, 3, 3))
...
@testitem "Mixing is per cell, and a species that is absent nowhere contributes" begin
    ...
    ch1 = DiffusionChannel(fill(2.0, 2, 3), fill(3.0, 2, 3), fill(4.0, 2, 3), fill(5.0, 2, 3))
    ch2 = DiffusionChannel(fill(6.0, 2, 3), fill(1.0, 2, 3), fill(8.0, 2, 3), fill(1.0, 2, 3))
...
@testitem "An empty cell falls back to the unweighted mean instead of NaN" begin
    ...
    ch1 = DiffusionChannel(fill(2.0, 2, 2), fill(3.0, 2, 2), fill(4.0, 2, 2), fill(5.0, 2, 2))
    ch2 = DiffusionChannel(fill(6.0, 2, 2), fill(1.0, 2, 2), fill(8.0, 2, 2), fill(1.0, 2, 2))
...
@testitem "Mixing is scale-invariant in the weights" begin
    ...
    ch1 = DiffusionChannel(fill(2.0, 3, 2), fill(3.0, 3, 2), fill(4.0, 3, 2), fill(5.0, 3, 2))
    ch2 = DiffusionChannel(fill(6.0, 3, 2), fill(1.0, 3, 2), fill(8.0, 3, 2), fill(1.0, 3, 2))
...
@testitem "Mixing rejects a ragged set of channels" begin
    ...
    ch1 = DiffusionChannel(fill(2.0, 3, 3), fill(3.0, 3, 3), fill(4.0, 3, 3), fill(5.0, 3, 3))
    ch2 = DiffusionChannel(fill(2.0, 4, 3), fill(3.0, 4, 3), fill(4.0, 4, 3), fill(5.0, 4, 3))
...
@testitem "Per-species policy hands every species its own operator, untouched" begin
    ...
    mk(v) = DiffusionChannel(fill(v, 2, 2), fill(1.0, 2, 2), fill(2v, 2, 2), fill(0.5, 2, 2))
...
@testitem "With one species the two policies are bit-identical" begin
    ...
    only_one = [
        [
            DiffusionChannel(fill(3.0, 4, 6), fill(1.5, 4, 6), fill(9.0, 4, 6), fill(0.1, 4, 6)),
            DiffusionChannel(zeros(4, 6), zeros(4, 6), fill(4.0, 4, 6), fill(2.0, 4, 6)),
        ],
    ]
    w = [fill(5.0e14, 4, 6)]
...
@testitem "Grouping rejects species that disagree about their mechanisms" begin
    ...
    mk() = DiffusionChannel(ones(2, 2), ones(2, 2), ones(2, 2), ones(2, 2))
    ragged = [[mk(), mk()], [mk()]]
    w = [ones(2, 2), ones(2, 2)]
